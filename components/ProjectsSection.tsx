      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-8">
          {displayedProjects.map((project) => (
            <div key={project.id} className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow flex flex-col">
              {/* Image */}
              ...
              <div className="flex flex-col flex-1 p-5">
                <span className={`inline-block text-xs font-bold px-2 py-1 rounded-full mb-3 self-start ${project.entityColor}`}>
                  {project.entity}
                </span>
                ...
                <div className="mt-5 flex flex-col gap-2">
                  <Link
                    ...
                    className="inline-flex items-center gap-2 w-full justify-center px-4 py-2.5 bg-brand-blue text-white font-semibold text-sm rounded-xl hover:bg-blue-900 transition-colors"
                  >
                    {memberLabels[lang]}
                  ...
                  <Link
                    href={`/${locale}/donate`}
                    className="inline-flex items-center gap-2 w-full justify-center px-4 py-2.5 bg-white text-brand-teal border border-brand-teal font-semibold text-sm rounded-xl hover:bg-brand-teal hover:text-white transition-colors"
                  >
                    {donateLabels[lang]}
                  </Link>
                </div>
